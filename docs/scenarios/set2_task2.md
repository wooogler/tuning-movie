...
|---|---------|------------|------|-----------|
| C1 | Night Ledger 7:00 PM: 붙은 좌석이 뒤 2열에만 남음 | P7 + P8 ↔ 좌석 현황 | within-stage | 8:30 PM 확인 |
| C2 | Night Ledger 8:30 PM → 11:05 PM 종료 | P6 ↔ 런타임+시간 | cross-stage | 다른 thriller 검토 |
| C3 | Night Ledger 전체 실패 | P5 + P6 + P7 + P8 ↔ 긴 런타임과 좌석 현황 | cross-stage | Cold Signal 선택 |
