...
> **Conflict C1** (cross-stage): P5 "3D" + P6 "가운데 좌석" + P3 "7 PM 이전"을 동시에 만족하는 Skyline 옵션이 없음
...
|---|---------|------------|------|-----------|
| C1 | Skyline Multiplex 3:00 PM 3D에는 좌석은 남아도 가운데 구역이 비어 있지 않음 | P5+P6 ↔ 좌석 현황 | cross-stage | Cedar Point Cinema로 전환 |
