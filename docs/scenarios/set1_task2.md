...
Today is Wednesday, March 11, 2026. You would like to see a movie with your spouse on Thursday night, March 12, 2026. Book movie tickets that satisfy the following conditions:
...
> 액션 영화는 Iron Meridian, Flashpoint Run 두 편뿐.
...
### Iron Meridian @ Both Theaters (Runtime: 2h 40m)
...
### Flashpoint Run @ Both Theaters (Runtime: 1h 40m)
...
> **Conflict C3** (cross-step): Iron Meridian (160분)는 P3+P4+P6을 동시에 충족하는 시간대 없음
...
| C3 | Iron Meridian 전체 실패 | P3+P4+P6 ↔ 160분 런타임 | cross-step | Flashpoint Run으로 전환 |
...
```
Iron Meridian → Northgate Cinema → Date (Thu, Mar 12, 2026) → Showtime
