...
import { formatLocalDate, getFixedCurrentDate } from '../../utils/studyDate';
...
function generateCalendarDays(
  ...
  for (let i = 0; i < startDayOfWeek; i++) {
    ...
    const dateStr = formatLocalDate(prevMonthDay);
    days.push({
      date: dateStr,
  ...
  if (remainingDays < 7) {
    for (let i = 1; i <= remainingDays; i++) {
      ...
      const dateStr = formatLocalDate(nextMonthDay);
      days.push({
        date: dateStr,
        dayNum: i,
        isCurrentMonth: false,
              ...
              className={`
                ...
                ${isOutsideMonth
                  ...
                  ? hasRestoredSelection
                    ? 'border-primary/45 bg-primary/12 text-fg-strong font-semibold'
